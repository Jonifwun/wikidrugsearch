...
class Main extends Component{
  ...
  render(){
    ...
    <form>    
      <input id="searchDrug" className="materialize-textarea" value={data.drugSearchTerm || ''} onChange={this.props.changeDrugSearchTerm} name="search" placeholder="Search By Drug Name" autoFocus></input>
      <div className="row">
        <div className="col s12 m4">
          <button id="searchButt" className="btn waves-effect waves-light " onClick={this.props.searchWiki} type="submit" name="action"><i className="material-icons left">search</i>Submit</button>
        </div>
        <div className="col s12 m4">
